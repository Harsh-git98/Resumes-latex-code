...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Souvik Majee
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:souvikmajee4813@gmail.com}{souvikmajee4813@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+91 79088 47140}{+91 79088 47140}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/souvik-majee-86387b26b/}{https://www.linkedin.com/in/souvik-majee}}%
        \kern 5.0 pt%
        \AND%
    \end{header}
...
\begin{onecolentry}
    I am Souvik Majee, a passionate Computer Science and Technology Engineering student in my pre-final year at the Indian Institute of Engineering Science and Technology, Shibpur. My academic journey has been driven by a strong commitment to innovation and excellence in the field of technology.I have a solid foundation in programming, problem-solving, and digital systems, complemented by active participation in technical societies and debates. My goal is to leverage my experience and learning to make a meaningful impact in the tech world.
\end{onecolentry}

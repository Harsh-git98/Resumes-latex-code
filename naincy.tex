...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont NAINCY GUPTA

        \vspace{5 pt}

        \normalsize
        \mbox{Howrah, West Bengal}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:naincygupta371@gmail.com}{naincygupta371@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+91 7080496840}{+91 70804 96840}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/naincy-gupta-12881528a/}{https://www.linkedin.com/in/naincy-gupta}}%
        \kern 5.0 pt%
        \AND%
    \end{header}
...
\begin{onecolentry}
  I am Naincy Gupta, a pre-final year Civil Engineering student at IIEST, Shibpur, with practical experience gained through hands-on research at IIT (BHU). My expertise spans sustainable construction practices, advanced laboratory testing, and comprehensive data analysis. I am proficient in front-end web development, including HTML, CSS, and JavaScript, with a solid understanding of responsive design and user experience principles. My strong problem-solving skills, combined with a passion for innovative engineering solutions, drive me to excel in dynamic, fast-paced environments.
.
...
\begin{onecolentry}
    \textbf{Summer Research Intern} \hfill \textit{\small \href{https://media.licdn.com/dms/image/v2/D5622AQE9TAwJtm5ulw/feedshare-shrink_1280/feedshare-shrink_1280/0/1720865514316?e=1727913600&v=beta&t=GojnncuZIsiILlB2KdrRCirUAcYHSG_RcImsYt5ENCU}{Certificate}}
    
    Indian Institute of Technology (Banaras Hindu University), Varanasi \\
    Advisor: Dr. Vishwajit Anand \\
    June 2024 - July 2024 \\
    
    \begin{highlights}
        \item Gained hands-on experience with advanced laboratory procedures, including Ultrasonic Pulse Velocity (UPV) testing, compressive strength analysis, and concrete casting and molding.
        \item Analyzed sustainable concrete mixes by reviewing numerous papers and articles, leading to the writing of comprehensive review papers.
        \item Enhanced proficiency with various tools and technologies, such as UPV machines, Universal Testing Machines (UTM), MS Excel, Word, Google Workspace, and Mendeley.
        \item Contributed to research efforts focused on sustainable construction practices, awaiting the publication of my first research paper.
    \end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
    \textbf{Language Proficiency:} Hindi (Native), English (Conversational).
\end{onecolentry}

\begin{onecolentry}
    \textbf{Technical Skills:} JAVA, Github, C, C++, HTML, CSS.
\end{onecolentry}
